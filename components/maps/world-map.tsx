...
// Map alpha-2 ISO (lowercase) to ISO 3166-1 numeric (used by world-atlas)
const ISO_NUMERIC: Record<string, string> = {
  ar: "032", au: "036", at: "040", be: "056", bo: "068", br: "076", ca: "124",
  cl: "152", cn: "156", co: "170", cz: "203", dk: "208", ee: "233", fi: "246",
  fr: "250", de: "276", gr: "300", hu: "348", is: "352", ie: "372", it: "380",
  jp: "392", kr: "410", kz: "398", lv: "428", lt: "440", lu: "442", mx: "484",
  nl: "528", no: "578", py: "600", pe: "604", pl: "616", pt: "620", ro: "642",
  ru: "643", rs: "688", sk: "703", si: "705", za: "710", es: "724", se: "752",
  ch: "756", tr: "792", ua: "804", gb: "826", us: "840", uy: "858", ve: "862",
};
...
export function WorldMap({ data }: Props) {
  ...
  return (
    <div className="relative w-full" style={{ aspectRatio: "960 / 500" }}>
      <svg viewBox="0 0 960 500" className="w-full h-full" role="img" aria-label="Global hantavirus activity map">
        <rect width="960" height="500" fill="transparent" />
        {geos.map((g) => {
          const numeric = String(g.id).padStart(3, "0");
          const record = numericToRecord.get(numeric);
          const fill = record ? STATUS_COLORS[record.status] : "var(--color-bg-tertiary)";
          ...
          return (
            <path
              ...
              strokeWidth={0.5}
              style={{ cursor: record ? "pointer" : "default", transition: "fill-opacity 0.15s" }}
              onMouseEnter={(e) => {
          ...
          {hover.record ? (
            <>
              <div className="text-[var(--color-fg-muted)]">
                {hover.record.cases.toLocaleString()} cases · {hover.record.deaths.toLocaleString()} deaths
              </div>
              <div className="text-[var(--color-fg-muted)]">{hover.record.strain}</div>
            </>
          ) : (
